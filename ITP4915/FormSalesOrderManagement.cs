...
(
    ...
    int nHeightEllipse
        ...
        private void button1SalesOrderManagement_Click_1(object sender, EventArgs e)
        {
        ...
        private void button2ProjectManagement_Click_1(object sender, EventArgs e)
        {
            FormProjectManagement formTarget = new FormProjectManagement();
            formTarget.Show();
            this.Hide();
        ...
        private void Button3InventoryControl_Click_1(object sender, EventArgs e)
        {
            FormInventoryControl formTarget = new FormInventoryControl();
            formTarget.Show();
            this.Hide();
        ...
        private void button4CustomerProfile_Click_1(object sender, EventArgs e)
        {
            FormCustomerProfile formTarget = new FormCustomerProfile();
            formTarget.Show();
            this.Hide();
        ...
        private void buttonSystemMaintenance_Click_1(object sender, EventArgs e)
        {
            FormSystemMaintenance formTarget = new FormSystemMaintenance();
            formTarget.Show();
            this.Hide();
        ...
        private void button5SystemMaintenance_Click_1(object sender, EventArgs e)
        {
            FormSecurityControl formTarget = new FormSecurityControl();
            formTarget.Show();
            this.Hide();
